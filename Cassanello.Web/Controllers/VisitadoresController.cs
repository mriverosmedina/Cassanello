...
namespace Cassanello.Web.Controllers
{
    public class VisitadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomVisitador,ApeVisitador,Telefono,Linea")] Visitador visitador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomVisitador,ApeVisitador,Telefono,Linea")] Visitador visitador)
        {
            if (id != visitador.Id)
            {
                return NotFound();
